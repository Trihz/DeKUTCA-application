...
class SynodPrayer extends StatefulWidget {
  const SynodPrayer({Key? key}) : super(key: key);

  @override
  State<SynodPrayer> createState() => _SynodPrayerState();
}

class _SynodPrayerState extends State<SynodPrayer> {
  String synodPrayer =
