import 'package:dekutca/DataClasses/stpeter_data_class.dart';
...
class _StPeterState extends State<StPeter> {
  ...
  String stPeterCordinator = "Paul Brian";
  String stPeterViceCordinator = "Mary Mbaire";
  String stPeterSecretary = "Paul Brian";
  String stPeterTreasurer = "Mary Mbaire";
  String stPeterCordinatorNumber = "*********";
  String stPeterViceCordinatorNumber = "*********";
  String stPeterSecretaryNumber = "*********";
  String stPeterTreasurerNumber = "*********";
  ...
  void readActivitesDetails() {
    ...
    reference.onValue.listen((event) {
      StPeterDataClass stPeterDataClass = StPeterDataClass(
      ...
      setState(() {
        partyVenue = stPeterDataClass.getPartyVenue;
        partyDate = stPeterDataClass.getPartyDate;
        hikeVenue = stPeterDataClass.getHikeVenue;
        hikeDate = stPeterDataClass.getHikeDate;
        charityVenue = stPeterDataClass.getCharityVenue;
        charityTime = stPeterDataClass.getCharityDate;
      });
    });
  }
